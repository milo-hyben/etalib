...
ERL_NIF_TERM
ta_macd(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    // declare the variables
    EtaStruct eta;
    EtaStruct* e = &eta;
...
ERL_NIF_TERM
ta_macdfix(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    // declare the variables
    EtaStruct eta;
    EtaStruct* e = &eta;
...
ERL_NIF_TERM
ta_ppo(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    // declare the variables
    EtaStruct eta;
    EtaStruct* e = &eta;
...
ERL_NIF_TERM
ta_apo(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    // declare the variables
    EtaStruct eta;
    EtaStruct* e = &eta;
